...
console.log(_js_format_js__WEBPACK_IMPORTED_MODULE_0___default().dateFormat('aaa'));
console.log(_js_format_js__WEBPACK_IMPORTED_MODULE_0___default().dateFormat('bbb'));
}();
/******/ })()
;
